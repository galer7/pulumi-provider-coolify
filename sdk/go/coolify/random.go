...
import (
	...
	"errors"
	"example.com/pulumi-coolify/sdk/go/coolify/internal"
...
func NewRandom(ctx *pulumi.Context,
	...
	var resource Random
	err := ctx.RegisterResource("coolify:index:Random", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRandom(ctx *pulumi.Context,
	...
	var resource Random
	err := ctx.ReadResource("coolify:index:Random", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
